...
import { createProblem, deleteProblem, getProblem, getProblemBySlug, updateProblem,deleteManyProblem } from '../controllers/problem.controllers.js';
...
router.route("/bulk-delete").delete(deleteManyProblem);
